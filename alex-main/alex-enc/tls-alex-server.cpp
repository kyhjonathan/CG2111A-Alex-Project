...
#define PRIVATE_CERT "alex.crt"
#define CA_CERT "signing.pem"
#define CLIENT_NAME "alex.epp.com"
...
int main()
{
    ...
    createServer(PRIVATE_KEY, PRIVATE_CERT, SERVER_PORT, *worker, CA_CERT, CLIENT_NAME, networkActive);
    /* TODO END */
